...
export const Loader2 = ({ className }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2v4m0 12v4m9-9h-4M7 12H3m15.364 6.364l-2.828-2.828M6.343 6.343l-2.829-2.829m12.728 0l-2.828 2.828M6.343 17.657l-2.829 2.829" />
  </svg>
)
